...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'form.phone.required': 'Contact Number is required',
    'form.company': 'Company',
    'form.company.required': 'Company is required',
    'form.position': 'Job Title / Role',
    'form.location': 'Location',
    'form.location.required': 'Location is required',
    'form.message': 'Message',
    'form.submit': 'Submit Request',
    'form.sending': 'Sending...',
    'form.agreement.error': 'You must accept the Terms and Conditions and the Privacy Notice to continue',
    'form.agreement.part1': 'I accept the ',
    'form.agreement.part2': 'Terms and Conditions',
    'form.agreement.part3': ' and the processing of my personal data by EDIRA to manage my request, in accordance with the ',
    'form.agreement.part4': 'Simplified Privacy Notice',
    'form.agreement.part5': '.',
    'form.success.title': 'Request Submitted',
    'form.success.desc': 'Your request has been successfully submitted. We will contact you shortly.',
    'form.error.title': 'Submission Error',
    'form.error.desc': 'There was an error submitting your request. Please try again.',
    ...
    // Careers
    'careersHero.prehead': 'Build what',
    'careersHero.title': 'Matters',
    'careersHero.subtitle': 'Join a team focused on solving real business challenges through data, AI, and strategic thinking.',
    'whoWeAre.title': 'Who',
    'whoWeAre.title.bold': 'we are',
    'whoWeAre.subtitle': 'At Edira, we are a team of builders, problem-solvers, and strategic thinkers. We work at the intersection of data, technology, and business to create solutions that drive real impact.',
    'whoWeAre.weValue': 'We value:',
    'whoWeAre.val1.title': 'Clarity over complexity',
    'whoWeAre.val2.title': 'Execution over theory',
    'whoWeAre.val3.title': 'Long-term thinking over quick wins.',
    'howWeWork.title': 'How we',
    'howWeWork.title.italic': 'work',
    'howWeWork.subtitle': 'How we approach every project, every challenge, and every outcome.',
    'howWeWork.card1.title': 'Ownership',
    'howWeWork.card1.desc': 'We take responsibility for outcomes, not just tasks.',
    'howWeWork.card2.title': 'Collaboration',
    'howWeWork.card2.desc': 'We work closely with clients and as a team to solve complex challenges.',
    'howWeWork.card3.title': 'Continuous Improvement',
    'howWeWork.card3.desc': 'We constantly learn, adapt, and refine how we work.',
    'careersCTA.title': 'Ready to',
    'careersCTA.title.italic': 'build',
    'careersCTA.title2': 'with us?',
    'careersCTA.subtitle': 'Join a team focused on creating meaningful impact through technology and strategy.',
    'careersCTA.button': 'Contact us',

    // Insights Article Header
    'article.breadcrumb': 'INDUSTRY / ANALYSIS',
  },
  es: {
    // Navbar
    ...
    'footer.privacyNotice': 'Aviso de Privacidad',
    ...
    'form.email.invalid': 'Ingresa un correo electrónico válido',
    'form.phone': 'Teléfono de contacto',
    'form.phone.required': 'El teléfono de contacto es obligatorio',
    'form.company': 'Empresa',
    'form.company.required': 'El nombre de la empresa es obligatorio',
    'form.position': 'Cargo / Puesto',
    'form.location': 'Ubicación',
    'form.location.required': 'La ubicación es obligatoria',
    'form.message': 'Mensaje',
    'form.submit': 'Enviar solicitud',
    'form.sending': 'Enviando...',
    'form.agreement.error': 'Debes aceptar los Términos y Condiciones y el Aviso de Privacidad para continuar',
    'form.agreement.part1': 'Acepto los ',
    'form.agreement.part2': 'Términos y Condiciones',
    'form.agreement.part3': ' y el tratamiento de mis datos personales por EDIRA para gestionar mi solicitud, de conformidad con el ',
    'form.agreement.part4': 'Aviso de Privacidad Simplificado',
    'form.agreement.part5': '.',
    'form.success.title': 'Solicitud enviada',
    'form.success.desc': 'Tu solicitud ha sido enviada con éxito. Nos pondremos en contacto contigo a la brevedad.',
    'form.error.title': 'Error de envío',
    'form.error.desc': 'Hubo un error al enviar tu solicitud. Por favor, inténtalo de nuevo.',
    ...
    // Careers
    'careersHero.prehead': 'Construye lo que',
    'careersHero.title': 'Importa',
    'careersHero.subtitle': 'Únete a un equipo enfocado en resolver retos de negocio a través de IA, datos y pensamiento estratégico.',
    'whoWeAre.title': 'Quiénes',
    'whoWeAre.title.bold': 'somos',
    'whoWeAre.subtitle': 'En Edira somos pensadores estratégicos, resolutores de problemas y constructores. Trabajamos en la intersección tecnológica para crear un impacto real.',
    'whoWeAre.weValue': 'Nuestros valores:',
    'whoWeAre.val1.title': 'Claridad sobre complejidad',
    'whoWeAre.val2.title': 'Ejecución sobre teoría',
    'whoWeAre.val3.title': 'Pensamiento a largo plazo',
    'howWeWork.title': 'Cómo',
    'howWeWork.title.italic': 'trabajamos',
    'howWeWork.subtitle': 'Nuestra filosofía para enfrentar cada reto y resultado.',
    'howWeWork.card1.title': 'Responsabilidad',
    'howWeWork.card1.desc': 'Nos hacemos dueños del resultado, no solo de las tareas.',
    'howWeWork.card2.title': 'Colaboración',
    'howWeWork.card2.desc': 'Trabajamos en conjunto para solucionar la complejidad.',
    'howWeWork.card3.title': 'Mejora Continua',
    'howWeWork.card3.desc': 'Aprendemos y refinamos constantemente cada esfuerzo.',
    'careersCTA.title': '¿Listo para',
    'careersCTA.title.italic': 'construir',
    'careersCTA.title2': 'con nosotros?',
    'careersCTA.subtitle': 'Únete a un equipo creando un verdadero impacto tecnológico.',
    'careersCTA.button': 'Contáctanos',

    // Insights Article Header
    'article.breadcrumb': 'INDUSTRIA / ANÁLISIS',
  },
};
