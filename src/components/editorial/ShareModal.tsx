          ...
          >
            ...
            <div className={styles.header}>
              <div className={styles.headerLeft}>
                ...
                <h2 className={styles.title}>Share this paper</h2>
              </div>
            ...
            {/* ── Copy Link ── */}
            <p className={styles.sectionLabel} style={{ marginTop: 'var(--space-6)' }}>Or copy link</p>
            ...
            <p className={styles.footerNote}>
              EDIRA Research · Decision Intelligence Whitepaper
            </p>
          </motion.div>
        </motion.div>
      )}
